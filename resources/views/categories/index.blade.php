...
@section('content')
    <div class="container w-25 border p-4 border p-4 my-4">
        <div class="row mx-auto">
            <form action="{{route('categories.store')}}" method="POST">
                ...
                @enderror
                <div class="mb-3">
                    <label for="name" class="form-label">Categoria a crear </label>
                    <input type="text" name="name" class="form-control">
                </div>
                <div class="mb-3">
                    <label for="color" class="form-label">Categoria color </label>
                ...
                <div class="row py-1">
                    ...
                    <div class="modal fade" id="modal-{{$category->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Eliminar definitivamente</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                            Desea eliminar la categoria y todas sus tareas subyacentes?
                            </div>
